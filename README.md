...
## Machine Learning Insights (Topic Modeling)

Για την εις βάθος κατανόηση του πλαισίου πίσω από τα παράπονα εφαρμόστηκε LDA. Σε αντίθεση με τα Word Clouds που εξετάζουν μεμονωμένες λέξεις, το Topic Modeling ανακάλυψε αυτόματα τα 5 κρυφά μοτίβα δυσαρέσκειας ομαδοποιώντας λέξεις που συνυπάρχουν στις κριτικές. Τα αποτελέσματα βασίστηκαν στο καθαρισμένο dataset μετά από αυστηρό φιλτράρισμα θορύβου και ελληνικών stopwords (μέσω του script 	opic_modeling_lda.py).

### Θέμα 1: Γενική Απαξίωση και Αξιολόγηση
Οι λέξεις χειρότερη, εξυπηρέτηση, απαράδεκτοι και μεταφορική κυριαρχούν σε αυτή την κατηγορία. Οι πελάτες δεν περιγράφουν απλά ένα μεμονωμένο συμβάν αλλά προβαίνουν στην τελική και απόλυτη αξιολόγηση της εκάστοτε εταιρείας.

### Θέμα 2: Εφαρμογή και Χρόνος Παράδοσης
Η δεύτερη ομάδα περιλαμβάνει λέξεις όπως εφαρμογή, παράδοση, ώρα και εμπειρία. Το συγκεκριμένο μοτίβο εστιάζει στην τεχνική πλευρά της αποστολής και καταδεικνύει την ανάγκη του κόσμου για σωστή ψηφιακή ενημέρωση μέσω των συστημάτων tracking.

### Θέμα 3: Ψευδείς Προσπάθειες Παράδοσης
Το πιο κλασικό λειτουργικό πρόβλημα αναδείχθηκε μέσω των λέξεων τηλέφωνο, σπίτι, μέρες, σηκώνουν και περιμένω. Οι χρήστες αναφέρουν μαζικά ότι βρίσκονταν μέρες στο σπίτι περιμένοντας, οι διανομείς δήλωσαν ψευδώς ότι δεν τους βρήκαν και τα τοπικά καταστήματα δεν απαντούν ποτέ στα τηλέφωνα για την επίλυση του προβλήματος.

### Θέμα 4: Οργή και Ανορθόγραφη Γραφή
Ο αλγόριθμος εντόπισε ένα ξεχωριστό μοτίβο βασισμένο αποκλειστικά σε λέξεις χωρίς τόνους όπως καταστημα, απαραδεκτοι, τηλεφωνο και μερες. Στη Μηχανική Μάθηση ο βιαστικός ή οργισμένος τρόπος γραφής από κινητά τηλέφωνα δημιουργεί συχνά το δικό του ξεχωριστό cluster το οποίο εδώ ταυτίζεται νοηματικά με το προηγούμενο θέμα.

### Θέμα 5: Θυρίδες Παραλαβής (Smart Lockers)
Το τελευταίο θέμα ανέδειξε λέξεις όπως locker, διεύθυνση και χωρίς. Αποτυπώνει τη σύγχρονη τάση των εταιρειών να δρομολογούν αυτόματα τα δέματα σε αυτοματοποιημένες θυρίδες, πολλές φορές χωρίς την προηγούμενη ρητή συγκατάθεση του παραλήπτη.

## Concept Drift: Η Εξέλιξη της Θεματολογίας (2019-2026)

<p align="left"><img src="images/11_Keyword_Drift.png" /></p>

Για να αποδειχθεί η αλλαγή στη συμπεριφορά των καταναλωτών και των εταιρειών με την πάροδο του χρόνου (Concept Drift), αναλύθηκε η συχνότητα εμφάνισης συγκεκριμένων λέξεων-κλειδιών ανά έτος. Αυτή η διαχρονική ανάλυση αποτυπώνει πώς η ίδια η γλώσσα των παραπόνων μεταλλάσσεται ανάλογα με τις τεχνολογικές εξελίξεις.

Η απόλυτη εκτόξευση των Smart Lockers αποτελεί το πιο εντυπωσιακό εύρημα. Από το 2019 έως το 2022 το συγκεκριμένο θέμα ήταν ουσιαστικά ανύπαρκτο στις κριτικές. Το 2023 έκανε τη δειλή του εμφάνιση και μέχρι το 2026 εκτοξεύτηκε ραγδαία καταλαμβάνοντας σχεδόν το 11% του συνόλου των παραπόνων. Αυτό αποδεικνύει μια ριζική αλλαγή στο λειτουργικό μοντέλο των εταιρειών.

Η σταδιακή εξαφάνιση του χάρτινου ειδοποιητηρίου (το κλασικό χαρτάκι στην πόρτα) αποτελεί την άλλη όψη του ίδιου νομίσματος. Ενώ την περίοδο της καραντίνας το 2021 και 2022 αποτελούσε βασικό παράπονο στο 5% των κριτικών, από το 2024 και έπειτα καταρρέει κοντά στο 1%. Ο κόσμος πλέον δεν περιμένει να βρει χαρτάκι, καθώς η έννοια της ειδοποίησης έχει αλλάξει μορφή.

Η ψηφιακή επικοινωνία μέσω μηνυμάτων (όπως SMS, Viber και mobile εφαρμογές) αποτελούσε τεράστιο θέμα συζήτησης την περίοδο 2019-2020 αγγίζοντας το 37% των αναφορών. Πλέον η χρήση τους έχει μετατραπεί στη νέα κανονικότητα, με το ποσοστό των σχετικών αναφορών να έχει σταθεροποιηθεί γύρω στο 15%, καθώς τα παράπονα έχουν μετατοπιστεί στις παραδόσεις μέσω θυρίδων.
